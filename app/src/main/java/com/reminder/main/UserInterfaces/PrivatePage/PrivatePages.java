package com.reminder.main.UserInterfaces.PrivatePage;
...
public class PrivatePages extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.private_page);
    ...
    private void getSqlData() {
        ...
        tasksAdapter = new TasksAdapter(taskList, this, this);
        taskRecyclerView.setAdapter(tasksAdapter);
    }
    ...
    public ArrayList<TaskData> getTaskList() {
        ...
        if (cursor.getCount() != 0) {
            ...
            Log.d("TAG", "getSQLData: " + cursor.getCount());
            cursor.moveToFirst();
            do {
    ...
    public void setContextualActionBarVisible(ApplicationCustomInterfaces.ContextualActionBarCallback contextualActionBarCallback, ApplicationCustomInterfaces.ManipulateTask manipulateTask) {
        ...
        actionMode = startSupportActionMode(new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                mode.getMenuInflater().inflate(R.menu.select_task_private_menu, menu);
                menu.getItem(1).getIcon().mutate().setTint(ContextCompat.getColor(PrivatePages.this, R.color.blue_violet));
                return true;
            }
